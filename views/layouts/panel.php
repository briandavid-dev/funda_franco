	              ...
	              <li>
	                ...
	                <ul class="menu">
	                  <li><!-- start message -->
	                    <a href="#">
	                      <div class="pull-left">
	                        <img src="web/resources/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
	                      </div>
	                      <h4>
	                        Support Team
	                  ...
	                  <li>
	                    <a href="#">
	                      <div class="pull-left">
	                        <img src="web/resources/AdminLTE/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
	                      </div>
	                      <h4>
	                  ...
	                  <li>
	                    <a href="#">
	                      <div class="pull-left">
	                        <img src="web/resources/AdminLTE/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
	                      </div>
	                      <h4>
	                        Developers
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info"> 
          <p><?php print Yii::$app->user->identity->usuario_nombre." ".Yii::$app->user->identity->usuario_apellido; ?></p>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php print Url::to(['usuarios/create']);?>"><i class="fa fa-circle-o"></i> Crear</a></li>
	...
	<footer class="main-footer">
	    <div class="pull-right hidden-xs">
	      BMO Soluciones Tecnológicas C.A. 
	    	<strong><a href="http://bmosoluciones.com" target="_blank">www.bmosoluciones.com</a>.</strong> 
	    	
	    </div>
	    &copy; <b><?php print Yii::$app->params['panelClienteNombre']; ?></b> <?= date('Y') ?> All rights reserved.
	</footer>
